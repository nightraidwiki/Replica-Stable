...
public class GnashAndLash : ISpecialAction
{
	...
	public override void OnActionCast(ActorCastInfo info)
	{
		...
		if (gameObject != null && info.ActionId == 26386)
		{
			DrawQueue.Clear();
			DrawQueue.Enqueue((new HashSet<uint> { 26389u }, new(IGameObject, DrawElement[])[1] { (gameObject, new DrawElement[1] { Donut }) }));
			DrawManager.Draw(Circle, gameObject);
		}
	}
}
